...
public class FT_TRANSFER_AREA extends Structure {
	...
	public volatile byte M_Sub1;
	public volatile byte M_Sub2;
	public volatile byte M_Sub3;
	...
	public volatile byte[] MPWM_Main = new byte[8];
	public volatile byte[] MPWM_Sub1 = new byte[8];
	public volatile byte[] MPWM_Sub2 = new byte[8];
	public volatile byte[] MPWM_Sub3 = new byte[8];
